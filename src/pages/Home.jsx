      ...
      <section className="bg-[url('./assets/book.png')] bg-cover sm: w-full h-[70vh] md:h-[100vh] flex items-start justify-st text-center sm:text-left p-4 sm:p-6">
        <div className="py-16 sm:py-20 px- 2sm:px-6 max-w-4xl w-full md:ml-25 lg:mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10 justify-center sm:justify-start">
            <button className="text-xs sm:text-sm rounded-md bg-curry py-3 px-6 text-black hover:opacity-90 transition-opacity">
              ADD BOOK
            </button>
            <button className="text-xs sm:text-sm rounded-md bg-[#029967] py-3 px-6 text-white hover:opacity-90 transition-opacity">
              VIEW BOOKS
            </button>
          </div>
        </div>
      ...
      <section className="bg-dark-green font-sans py-12 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-3xl sm:text-4xl font-bold text-light-green mb-4">
              Frequently Asked Questions
            </h1>
            <p className="text-base sm:text-lg text-light-green">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
              ...
              <div className="faq-content px-4 sm:px-6 pb-4 sm:pb-6 hidden">
                <p className="text-sm sm:text-base text-gray-600">
                  To add a book, click on the "Add Book" button at the top right
                  corner of our website. You'll need to provide some data, and
                  fill in some basic information on the form.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
              ...
              <div className="faq-content px-4 sm:px-6 pb-4 sm:pb-6 hidden">
                <p className="text-sm sm:text-base text-gray-600 mb-3">
                  ...
                  American Express, and Discover. We also support payments
                  through PayPal and bank transfers for certain plans.
                </p>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
              ...
              <div className="faq-content px-4 sm:px-6 pb-4 sm:pb-6 hidden">
                <p className="text-sm sm:text-base text-gray-600">
                  ...
                  cancel during your billing period, you'll continue to have
                  access to our services until the end of that period. We don't
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
              ...
              <div className="faq-content px-4 sm:px-6 pb-4 sm:pb-6 hidden">
                <p className="text-sm sm:text-base text-gray-600">
                  ...
                  Play Store. All your data will sync automatically between the
      ...
      <section className="px-4 py-12 bg-cyan-200 grid grid-cols-1 md:grid-cols-3 gap-6 sm:px-6 lg:px-8">
        ...
        <div className="bg-green-300 mt-15 rounded-2xl p-6 text-black">
          ...
          <p className="font-light text-xs sm:text-sm mt-2">
            Name: Daniel Owusu
            <br />
            Review: "The new Library Management App has made it incredibly easy
            for us to manage books. Adding, updating, or removing books is
            seamless, and the real-time success/error messages help us know
            what's working instantly. The app is fast, intuitive, and has
            significantly reduced manual entry errors."
          </p>
        </div>
        <div className="bg-gray-50 mt-15 rounded-2xl p-6 text-black">
          ...
          <p className="font-light text-xs sm:text-sm mt-2">
            Name: Josephine Addo
            <br />
            Review: "The backend is rock solid! The API documentation made
            integration with our internal tools very easy, and input validation
            prevents data entry mistakes. I also appreciate the effort put into
            error handling, it makes debugging so much easier."
          </p>
        </div>
